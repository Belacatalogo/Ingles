...
function lesson(level, pillar, order, mapItem, options = {}, prevLessonId) {
  ...
  return {
    ...
    order: base.order,
    // Preserve computed prerequisites when ready content omits them (e.g. deep content files
    // that don't set prerequisites in the factory call end up with prerequisites:[]).
