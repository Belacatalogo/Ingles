...
export const A1_GRAMMAR_MAP = [
  ...
  item('My, your, his, her + simple be statements', 'familyDescription', 'Usar possessivos básicos em contexto de vida pessoal com verbo to be.', ['possessives', 'personal-life', 'deep'], ['Usa my/your/his/her em contexto pessoal'], '', 'A1-PERSONAL-GRAMMAR-001'),
];
...
export const A1_VOCABULARY_MAP = [
  ...
  item('Personal life words', 'familyDescription', 'Vocabulário de vida pessoal: telefone, endereço, e-mail, hobbies e aulas.', ['personal-life', 'deep'], ['Usa phone number, email address, hobby'], '', 'A1-PERSONAL-VOCABULARY-001'),
];
...
export const A1_READING_MAP = [
  ...
  item('A personal life profile', 'familyDescription', 'Ler perfil pessoal A1.2 e responder com evidência textual.', ['reading', 'personal-life', 'deep'], ['Responde com evidência do texto'], '', 'A1-PERSONAL-READING-001'),
];
export const A1_LISTENING_MAP = [
  ...
  item('Personal information exchange', 'familyDescription', 'Ouvir troca de informações pessoais e responder após segunda escuta.', ['listening', 'personal-life', 'deep'], ['Identifica nome, cidade, telefone, hobby'], '', 'A1-PERSONAL-LISTENING-001'),
];
export const A1_SPEAKING_MAP = [
  ...
  item('Talk about yourself and someone else', 'familyDescription', 'Falar sobre si e outra pessoa usando my/his/her em produção oral.', ['speaking', 'personal-life', 'deep'], ['Usa my/his/her em fala sobre si e outro'], '', 'A1-PERSONAL-SPEAKING-001'),
];
export const A1_WRITING_MAP = [
  ...
  item('Write a short personal life paragraph', 'familyDescription', 'Escrever parágrafo de vida pessoal com my/his/her, is/are e pontuação.', ['writing', 'personal-life', 'deep'], ['Escreve 6-8 frases sobre si e outra pessoa'], '', 'A1-PERSONAL-WRITING-001'),
];
