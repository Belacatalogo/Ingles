...
export const A1_GRAMMAR_MAP = [
  ...
  item('My, your, his, her + simple be statements', 'familyDescription', 'Usar possessivos básicos em contexto de vida pessoal com verbo to be.', ['possessives', 'personal-life', 'deep'], ['Usa my/your/his/her em contexto pessoal'], '', 'A1-GRAMMAR-029-PERSONAL'),
];

export const A1_VOCABULARY_MAP = [
  ...simple(['Greetings','Personal information','Numbers 0–100','Countries and nationalities','Family','Jobs and professions','Classroom objects','Common adjectives','Colors','Days and months','Telling the time','Daily routine verbs','Food and drinks','Places in town','House and furniture','Clothes','Weather','Basic feelings','Common verbs','Review Vocabulary A1'], (n) => n <= 5 ? 'foundations' : n <= 10 ? 'familyDescription' : n <= 12 ? 'routinePresent' : n <= 19 ? 'practicalSituations' : 'reviewsCheckpoints', 'Vocabulário essencial A1', 'vocabulary').map((lesson) => lesson.title === 'Review Vocabulary A1' ? { ...lesson, checkpoint: 'vocabulary-review' } : lesson),
...
export const A1_READING_MAP = [
  ...
  item('A personal life profile', 'familyDescription', 'Ler perfil pessoal A1.2 e responder com evidência textual.', ['reading', 'personal-life', 'deep'], ['Responde com evidência do texto'], '', 'A1-READING-022-PERSONAL'),
];
...
export const A1_WRITING_MAP = [
  ...
  item('Write a short personal life paragraph', 'familyDescription', 'Escrever parágrafo de vida pessoal com my/his/her, is/are e pontuação.', ['writing', 'personal-life', 'deep'], ['Escreve 6-8 frases sobre si e outra pessoa'], '', 'A1-WRITING-018-PERSONAL'),
];
