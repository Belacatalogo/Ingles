...
export const C1_DEEP_PROFESSIONAL_PART1 = Object.freeze([
  ...
  createGrammarLesson({
    ...
    portugueseContrast: [task('Em Advanced conditional and hypothetical language in professional communication, observe que a estrutura do inglês difere da ordem natural do português.'), task('Não traduza literalmente; identifique o padrão do inglês antes de produzir.')], 
  ...
  createGrammarLesson({
    ...
    portugueseContrast: [task('Em Formal register in professional communication: tonal calibration, distancing, and indirect speech acts, observe que a estrutura do inglês difere da ordem natural do português.'), task('Não traduza literalmente; identifique o padrão do inglês antes de produzir.')], 
