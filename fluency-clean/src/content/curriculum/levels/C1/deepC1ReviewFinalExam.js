...
None of this is inevitable. The architecture of the attention economy is a design choice, and design choices can be unmade. But the political economy of the platforms — the interests that benefit from the current arrangement — makes reform structurally difficult. The question is whether the democratic systems that are most threatened by this development have the political will and institutional capacity to regulate it before the damage becomes irreversible.`,
  ...
  createSpeakingLesson({
    ...
    modelPhrases: [
      'The most intellectually challenging aspect was the counter-factual conditional — specifically, calibrating certainty in spoken argument.',
      'What I found most striking was how the concept of epistemic modality changed the way I think about academic discourse.',
      'I would single out the distinction between structural ambiguity and interpretive ambiguity as the idea that has stayed with me.',
      'In retrospect, what I think has developed most is my ability to construct a nuanced position under real-time pressure.',
      'The skill I still find most difficult is integrating advanced grammar naturally into spontaneous speech without sounding rehearsed.',
      'If I were to identify one idea from the course that genuinely shifted my perspective, it would be the relationship between register and audience.',
    ],
    pronunciationFocus: {
