    ...
    targetCategories: [
      {
        ...
        items: [
          { phrase: 'it is virtually certain that', note: 'Near-absolute; appropriate for scientific consensus or overwhelmingly corroborated claims.' },
          { phrase: 'the evidence leaves little room for doubt that', note: 'Strong claim with implicit acknowledgement that some doubt remains.' },
          { phrase: 'it can be said with a high degree of confidence that', note: 'Formal quantified certainty expression.' },
          { phrase: 'in all probability', note: 'Phrase meaning "almost certainly" — more formal than "probably".' },
        ],
      },
      {
        category: 'Moderate certainty',
        items: [
          { phrase: 'the weight of evidence suggests', note: 'Implies that multiple sources point in the same direction; calibrated scholarly claim.' },
          { phrase: 'on balance, it appears that', note: 'Acknowledges complexity while stating a directional conclusion.' },
          { phrase: 'the evidence is broadly consistent with the view that', note: 'The claim is supported but not conclusively proven.' },
          { phrase: 'it seems reasonable to conclude that', note: 'Moderate certainty with epistemic modesty.' },
          { phrase: 'there are strong grounds for thinking that', note: 'Evidence-based but qualified.' },
        ],
      },
      {
        category: 'Lower certainty / tentative',
        items: [
          { phrase: 'the tentative suggestion emerges that', note: 'Flagging a hypothesis, not a finding.' },
          { phrase: 'the data are at least consistent with the hypothesis that', note: 'Very careful: consistent with ≠ proves.' },
          { phrase: 'conceivably', note: 'Possible but not strongly supported — use sparingly.' },
          { phrase: 'it is not implausible that', note: 'Double negative for very tentative claim.' },
          { phrase: 'this may, in part, reflect the fact that', note: '"May" + "in part" + "reflect" — multiple hedges stacked for extreme tentativeness.' },
        ],
      },
      {
        category: 'Evidentiality — how we know',
        items: [
          { phrase: 'ostensibly', note: 'According to appearances (with possible scepticism about the reality).' },
          { phrase: 'purportedly', note: 'As claimed (with implied scepticism about the claim).' },
          { phrase: 'on the available evidence', note: 'Scoped to the evidence we have — implies other evidence might change the picture.' },
          { phrase: 'according to the best available data', note: 'Qualifies the claim by the quality and availability of evidence.' },
          { phrase: 'as the literature consistently shows', note: 'Attribution to the body of research, not a single source.' },
          { phrase: 'to all intents and purposes', note: 'For practical purposes, even if technically not exactly so.' },
        ],
      },
    ],
    practiceExercises: [
