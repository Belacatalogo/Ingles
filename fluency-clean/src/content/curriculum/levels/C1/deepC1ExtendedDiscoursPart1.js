...
export const C1_DEEP_EXTENDED_DISCOURSE_PART1 = Object.freeze([
  ...
  createGrammarLesson({
    ...
    portugueseContrast: [task('Em Advanced discourse markers: signposting, concession, and qualification at C1, observe que a estrutura do inglês difere da ordem natural do português.'), task('Não traduza literalmente; identifique o padrão do inglês antes de produzir.')], 
  ...
  createGrammarLesson({
    ...
    portugueseContrast: [task('Em Hedging and stance: calibrating certainty and commitment in academic writing, observe que a estrutura do inglês difere da ordem natural do português.'), task('Não traduza literalmente; identifique o padrão do inglês antes de produzir.')], 
  ...
  createGrammarLesson({
    ...
    portugueseContrast: [task('Em Text-level cohesion: reference chains, substitution, ellipsis and lexical cohesion, observe que a estrutura do inglês difere da ordem natural do português.'), task('Não traduza literalmente; identifique o padrão do inglês antes de produzir.')], 
