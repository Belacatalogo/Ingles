...
export const C2_DEEP_RHETORIC_PART1 = Object.freeze([
  ...
  createVocabularyLesson({
    ...
    recognitionPractice: [{ question: 'Vocabulary: Register and style — navigating the full spectrum of formal English at C2 — qual vocabulário desta aula significa "Apparently or purportedly — but the word implies a gap between the surface appearance and the reality; used to signal that the stated reason or appearance may not be the real one."?', options: ['ostensibly', 'precipitate (adj/verb)', 'inimical'], answer: 'ostensibly', explanation: 'ostensibly = Apparently or purportedly — but the word implies a gap between the surface appearance and the reality; used to signal that the stated reason or appearance may not be the real one.; vocabulário trabalhado nesta aula.' }, { question: 'Vocabulary: Register and style — navigating the full spectrum of formal English at C2 — qual opção combina com "ostensibly"?', options: ['Apparently or purportedly — but the word implies a gap between the surface appearance and the reality; used to signal that the stated reason or appearance may not be the real one.', 'As adjective: done suddenly or without careful consideration (near-synonym: rash, hasty). As verb: cause something, especially suddenly or unexpectedly.', 'Tending to obstruct or harm; hostile to; incompatible with.'], answer: 'Apparently or purportedly — but the word implies a gap between the surface appearance and the reality; used to signal that the stated reason or appearance may not be the real one.', explanation: 'ostensibly significa Apparently or purportedly — but the word implies a gap between the surface appearance and the reality; used to signal that the stated reason or appearance may not be the real one. no contexto desta aula.' }],
  }),
  ...
  createVocabularyLesson({
    ...
    recognitionPractice: [{ question: 'Vocabulary: The vocabulary of intellectual critique — evaluating ideas, arguments, and texts at C2 — qual vocabulário desta aula significa "Already covered at C1; at C2, learn the collocations and deployment patterns more precisely."?', options: ['reductive', 'parsimonious', 'intractable'], answer: 'reductive', explanation: 'reductive = Already covered at C1; at C2, learn the collocations and deployment patterns more precisely.; vocabulário trabalhado nesta aula.' }, { question: 'Vocabulary: The vocabulary of intellectual critique — evaluating ideas, arguments, and texts at C2 — qual opção combina com "reductive"?', options: ['Already covered at C1; at C2, learn the collocations and deployment patterns more precisely.', 'Using as few assumptions or elements as possible to explain something; in academic contexts, usually positive — a parsimonious explanation is elegant and economical.', 'Hard or impossible to deal with, manage, or solve; stubbornly persistent.'], answer: 'Already covered at C1; at C2, learn the collocations and deployment patterns more precisely.', explanation: 'reductive significa Already covered at C1; at C2, learn the collocations and deployment patterns more precisely. no contexto desta aula.' }],
  }),
