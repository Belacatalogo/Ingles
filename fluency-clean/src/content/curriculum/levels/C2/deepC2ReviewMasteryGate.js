...
export const C2_DEEP_REVIEW_MASTERY_GATE = Object.freeze([
  ...
  createVocabularyLesson({
    ...
    recognitionPractice: [{ question: 'Which verb means to claim confidently without argument?', options: ['assert', 'contend', 'maintain'], answer: 'assert', explanation: 'Assert means to state something firmly and confidently as a fact.' }, { question: 'Which verb implies arguing against opposition or difficulty?', options: ['contend', 'assert', 'maintain'], answer: 'contend', explanation: 'Contend implies a contest of ideas, arguing against resistance.' }],
  }),
...
The virtue I am advocating — intellectual humility — is not the same as intellectual timidity. The humble intellectual still takes positions, still defends them, still insists when the evidence supports insistence. What they resist is the illegitimate projection of authority beyond its evidential basis — either outside one's field, or inside it at a level of certainty the evidence does not support.`,
  ...
  createSpeakingLesson({
    ...
    pronunciationFocus: {
      ...
      tips: [
        'Shadow: "This is a question I haven\'t thought about before; let me think through it..." — stress THOUGHT and THINK. Practise the epistemic honesty opening with steady, unhurried pacing.',
        '"Intellectual humility seems in tension with intellectual confidence." — stress HUmility and CONfidence. Practise the abstract noun parallelism with balanced stress.',
        '"What does your answer reveal about what C2 mastery actually is?" — stress rEVEAL and ACTually. Practise the meta-question with genuine curiosity intonation.',
        '"If so, what follows for how we teach history?" — stress FOLlows and TEACH. Practise the formal conditional consequence with confident falling intonation.',
      ],
    },
    tasks: [
      task(
