...
export const C2_DEEP_BRIDGE_PART1 = Object.freeze([
  ...
  createVocabularyLesson({
    ...
    recognitionPractice: [{ question: 'Vocabulary: Precision and near-synonyms — navigating the fine distinctions that define C2 mastery — qual vocabulário desta aula significa "To refer: to mention explicitly and directly. To allude: to mention indirectly, without naming explicitly. "She referred to the study" (named it). "She alluded to the controversy" (suggested it without naming it). The distinction is directness of reference."?', options: ['allude vs. refer', 'assert vs. contend vs. maintain', 'elucidate vs. clarify vs. explain'], answer: 'allude vs. refer', explanation: 'allude vs. refer = To refer: to mention explicitly and directly. To allude: to mention indirectly, without naming explicitly. "She referred to the study" (named it). "She alluded to the controversy" (suggested it without naming it). The distinction is directness of reference.; vocabulário trabalhado nesta aula.' }, { question: 'Vocabulary: Precision and near-synonyms — navigating the fine distinctions that define C2 mastery — qual opção combina com "allude vs. refer"?', options: ['To refer: to mention explicitly and directly. To allude: to mention indirectly, without naming explicitly. "She referred to the study" (named it). "She alluded to the controversy" (suggested it without naming it). The distinction is directness of reference.', 'Assert: claim as true, often confidently or without giving reasons. Contend: argue against opposition or in a context of debate. Maintain: continue to hold a position in the face of challenge — to persist in a claim already made.', 'Explain: make intelligible. Clarify: remove confusion or ambiguity. Elucidate: shed light on something complex or obscure — typically used when the original is already partially understood but not fully. Elucidate is slightly more formal and implies more work on the part of the explicator.'], answer: 'To refer: to mention explicitly and directly. To allude: to mention indirectly, without naming explicitly. "She referred to the study" (named it). "She alluded to the controversy" (suggested it without naming it). The distinction is directness of reference.', explanation: 'allude vs. refer significa To refer: to mention explicitly and directly. To allude: to mention indirectly, without naming explicitly. "She referred to the study" (named it). "She alluded to the controversy" (suggested it without naming it). The distinction is directness of reference. no contexto desta aula.' }],
  }),
  ...
  createVocabularyLesson({
    ...
    recognitionPractice: [{ question: 'Vocabulary: The meta-vocabulary of intellectual discourse — describing argument, method, and knowledge at C2 — qual vocabulário desta aula significa "Promoting a particular cause or point of view in a biased or misleading way; presenting an argument with a hidden agenda that distorts the evidence or framing."?', options: ['tendentious', 'beg the question', 'equivocate'], answer: 'tendentious', explanation: 'tendentious = Promoting a particular cause or point of view in a biased or misleading way; presenting an argument with a hidden agenda that distorts the evidence or framing.; vocabulário trabalhado nesta aula.' }, { question: 'Vocabulary: The meta-vocabulary of intellectual discourse — describing argument, method, and knowledge at C2 — qual opção combina com "tendentious"?', options: ['Promoting a particular cause or point of view in a biased or misleading way; presenting an argument with a hidden agenda that distorts the evidence or framing.', 'To assume the conclusion of an argument in one of its premises (circular reasoning). Often misused to mean "raise the question" — at C2, use it correctly.', 'To use language in an ambiguous way to avoid committing to a position; to speak or write with deliberate vagueness to mislead or avoid responsibility.'], answer: 'Promoting a particular cause or point of view in a biased or misleading way; presenting an argument with a hidden agenda that distorts the evidence or framing.', explanation: 'tendentious significa Promoting a particular cause or point of view in a biased or misleading way; presenting an argument with a hidden agenda that distorts the evidence or framing. no contexto desta aula.' }],
  }),
