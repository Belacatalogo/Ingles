...
export const C2_DEEP_NATIVE_PRODUCTION_PART1 = Object.freeze([
  ...
  createVocabularyLesson({
    ...
    recognitionPractice: [{ question: 'Vocabulary: Precision in evaluation — the fine distinctions of intellectual assessment at C2 — qual vocabulário desta aula significa "Intelligently analytical and clear-thinking; cutting directly to the point with sharpness."?', options: ['incisive', 'specious', 'germane'], answer: 'incisive', explanation: 'incisive = Intelligently analytical and clear-thinking; cutting directly to the point with sharpness.; vocabulário trabalhado nesta aula.' }, { question: 'Vocabulary: Precision in evaluation — the fine distinctions of intellectual assessment at C2 — qual opção combina com "incisive"?', options: ['Intelligently analytical and clear-thinking; cutting directly to the point with sharpness.', 'Superficially plausible or true but actually wrong or misleading; deceptively attractive.', 'Relevant to a subject under consideration; pertinent.'], answer: 'Intelligently analytical and clear-thinking; cutting directly to the point with sharpness.', explanation: 'incisive significa Intelligently analytical and clear-thinking; cutting directly to the point with sharpness. no contexto desta aula.' }],
  }),
  ...
  createVocabularyLesson({
    ...
    recognitionPractice: [{ question: 'Vocabulary: Sophisticated hedging — epistemic vocabulary beyond modal verbs — qual vocabulário desta aula significa "In a hesitant or exploratory way; as a first step or provisional approach."?', options: ['tentatively', 'ostensibly', 'purportedly'], answer: 'tentatively', explanation: 'tentatively = In a hesitant or exploratory way; as a first step or provisional approach.; vocabulário trabalhado nesta aula.' }, { question: 'Vocabulary: Sophisticated hedging — epistemic vocabulary beyond modal verbs — qual opção combina com "tentatively"?', options: ['In a hesitant or exploratory way; as a first step or provisional approach.', 'Review from C2-VOCABULARY-003; at mastery level, note: can function as a hedge when the stated reason is presented as potentially misleading.', 'As is claimed, especially when the claim is doubted; allegedly.'], answer: 'In a hesitant or exploratory way; as a first step or provisional approach.', explanation: 'tentatively significa In a hesitant or exploratory way; as a first step or provisional approach. no contexto desta aula.' }],
  }),
