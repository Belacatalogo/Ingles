...
const readingLessons = ['Short introductions', 'A simple profile', 'A family description'].map((title, index) => createReadingLesson({
  ...
  comprehensionQuestions: [q('Qual é o assunto principal do texto?', ['apresentação pessoal/família', 'receita de comida', 'história de viagem'], 'apresentação pessoal/família', 'O texto fala de informações pessoais.'), q('O texto fala sobre o Brasil?', ['Sim', 'Não'], 'Sim'), q('Há pessoas no texto?', ['Sim', 'Não'], 'Sim'), q('O texto usa frases curtas?', ['Sim', 'Não'], 'Sim'), q('Qual palavra aparece no texto?', ['English', 'airplane', 'hospital'], 'English'), q('O texto é adequado para A1?', ['Sim', 'Não'], 'Sim'), q('A pessoa estuda inglês?', ['Sim', 'Não'], 'Sim'), q('O texto tem informações pessoais?', ['Sim', 'Não'], 'Sim')],
...
const listeningLessons = ['Greetings and names', 'Spelling names', 'Numbers and phone numbers', 'Countries and cities'].map((title, index) => createListeningLesson({
  ...
  comprehensionQuestions: [q('A pessoa fala o nome?', ['Sim', 'Não'], 'Sim'), q('A pessoa é do Brasil?', ['Sim', 'Não'], 'Sim'), q('Ela estuda inglês?', ['Sim', 'Não'], 'Sim'), q('Ela fala rápido ou devagar?', ['devagar', 'rápido'], 'devagar'), q('Lucas é amigo?', ['Sim', 'Não'], 'Sim'), q('O áudio fala de rotina?', ['Sim', 'Não'], 'Sim'), q('O objetivo é entender conversas simples?', ['Sim', 'Não'], 'Sim'), q('O áudio é A1?', ['Sim', 'Não'], 'Sim')],
