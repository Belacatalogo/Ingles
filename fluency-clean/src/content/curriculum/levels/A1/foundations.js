...
const vocabularyLessons = A1_VOCABULARY_MAP.slice(0, 5).map((itemData, index) => createVocabularyLesson({
  ...
  recognitionPractice: [{ question: 'Escolha a palavra mais adequada para cumprimentar.', options: ['Hello', 'Blue', 'Chair'], answer: 'Hello', explanation: '' }, { question: 'Qual palavra fala de país?', options: ['Brazil', 'Monday', 'Book'], answer: 'Brazil', explanation: '' }, { question: 'Qual palavra fala de família?', options: ['mother', 'city', 'number'], answer: 'mother', explanation: '' }, { question: 'Qual é uma pessoa?', options: ['teacher', 'table', 'red'], answer: 'teacher', explanation: '' }, { question: 'Qual é número?', options: ['ten', 'friend', 'hello'], answer: 'ten', explanation: '' }, { question: 'Qual significa nome?', options: ['name', 'city', 'job'], answer: 'name', explanation: '' }, { question: 'Qual pode ser cidade?', options: ['São Paulo', 'teacher', 'book'], answer: 'São Paulo', explanation: '' }, { question: 'Qual é cumprimento?', options: ['Good morning', 'Seventeen', 'Phone'], answer: 'Good morning', explanation: '' }],
