...
export const A1_DEEP_PRACTICAL_SITUATIONS_HOUSE = Object.freeze([
  createGrammarLesson({
    ...
    guidedBeforeQuiz: [task('Complete: There ___ a bed in my room.', 'is'), task('Complete: There ___ two chairs in the kitchen.', 'are'), task('Pergunta: ___ there a bathroom?', 'Is: perguntas com there começam com is/are.'), task('Negativa: There ___ a TV.', 'isn’t')],
    ...
    controlledPractice: [task('Complete: There ___ a table.', 'is'), task('Complete: There ___ two windows.', 'are'), task('Complete: ___ there a bed?', 'Is: singular usa is there em pergunta.'), task('Complete: ___ there three chairs?', 'Are')],
