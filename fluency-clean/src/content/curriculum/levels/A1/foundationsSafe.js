...
const vocabularyLessons = A1_VOCABULARY_MAP.slice(0, 5).map((itemData, index) => createVocabularyLesson({
  ...
  recognitionPractice: [{ question: 'Qual palavra serve para cumprimentar?', options: ['Hello', 'Blue', 'Table'], answer: 'Hello', explanation: 'Hello é a saudação mais básica em inglês.' }, { question: 'Qual palavra fala de país?', options: ['Brazil', 'Monday', 'Book'], answer: 'Brazil', explanation: 'Brazil é nome de país.' }, { question: 'Qual palavra fala de família?', options: ['mother', 'city', 'number'], answer: 'mother', explanation: 'Mother é palavra de família.' }, { question: 'Qual é uma pessoa?', options: ['teacher', 'table', 'red'], answer: 'teacher', explanation: 'Teacher é pessoa; table é objeto, red é cor.' }, { question: 'Qual significa nome?', options: ['name', 'city', 'job'], answer: 'name', explanation: 'Name significa nome em inglês.' }, { question: 'Qual pode ser cidade?', options: ['São Paulo', 'teacher', 'book'], answer: 'São Paulo', explanation: 'São Paulo é nome de cidade.' }],
