...
const grammarTopics = [
  {
    ...
    guided: [
      ...
      q('Qual pronome substitui “Luis”?', ['He', 'She', 'It'], 'He'),
      q('Qual pronome substitui “my mother”?', ['She', 'He', 'They'], 'She'),
      q('Qual pronome substitui “my friends”?', ['It', 'They', 'He'], 'They'),
      q('Qual frase evita erro de português?', ['I am a student.', 'Am a student.', 'Student I am a.'], 'I am a student.'),
      q('Escolha o modelo correto.', ['They are friends.', 'They is friends.', 'They friends are.'], 'They are friends.'),
    ],
    transforms: [
      q('Substitua “Maria” por pronome: Maria is my friend.', ['She is my friend.', 'He is my friend.', 'It is my friend.'], 'She is my friend.'),
      q('Substitua “the book” por pronome: The book is blue.', ['He is blue.', 'It is blue.', 'They are blue.'], 'It is blue.'),
      q('Corrija: Is Ana.', ['She is Ana.', 'Ana she.', 'They is Ana.'], 'She is Ana.'),
      q('Corrija: Luis and Ana is here.', ['They are here.', 'It is here.', 'He are here.'], 'They are here.'),
    ],
  },
  {
    ...
    guided: [
      q('Complete: I ___ a student.', ['is', 'am', 'are'], 'am'),
      q('Complete: She ___ happy.', ['are', 'is', 'am'], 'is'),
      q('Complete: They ___ friends.', ['am', 'is', 'are'], 'are'),
      q('Qual frase está correta?', ['I am from Brazil.', 'I is from Brazil.', 'I are from Brazil.'], 'I am from Brazil.'),
      q('Corrija: She are here.', ['She am here.', 'She is here.', 'She here is.'], 'She is here.'),
      q('Complete: We ___ ready.', ['are', 'is', 'am'], 'are'),
      q('Complete: It ___ blue.', ['are', 'am', 'is'], 'is'),
      q('Qual opção usa you corretamente?', ['You is kind.', 'You are kind.', 'You am kind.'], 'You are kind.'),
      q('Complete: My phone ___ black.', ['is', 'are', 'am'], 'is'),
      q('Escolha a frase afirmativa correta.', ['He is from Brazil.', 'Is he from Brazil?', 'He not is from Brazil.'], 'He is from Brazil.'),
    ],
    transforms: [
      q('Corrija: He are a teacher.', ['He am a teacher.', 'He is a teacher.', 'He teacher is.'], 'He is a teacher.'),
      q('Corrija: They is students.', ['They are students.', 'They am students.', 'They students are.'], 'They are students.'),
      q('Monte a frase correta.', ['A student I am.', 'I am a student.', 'I student am.'], 'I am a student.'),
      q('Escolha o bloco correto para “ela está pronta”.', ['She are ready.', 'She is ready.', 'She am ready.'], 'She is ready.'),
    ],
  },
  {
    ...
    guided: [q('Complete: I am ___ tired.', ['not', 'no', 'don’t'], 'not'), q('Complete: She ___ not here.', ['am', 'are', 'is'], 'is'), q('Complete: They are ___ teachers.', ['not', 'no', 'is'], 'not'), q('Qual frase é negativa?', ['We are ready.', 'Are we ready?', 'We are not ready.'], 'We are not ready.'), q('Corrija: I not am late.', ['I am not late.', 'I not late am.', 'I no am late.'], 'I am not late.'), q('Complete: It ___ not red.', ['is', 'are', 'am'], 'is'), q('Qual opção está correta?', ['She is not my sister.', 'She not is my sister.', 'She no my sister.'], 'She is not my sister.'), q('Complete: You ___ not wrong.', ['are', 'is', 'am'], 'are')],
    transforms: [q('Transforme: I am ready.', ['I am not ready.', 'I not am ready.', 'I am ready not.'], 'I am not ready.'), q('Transforme: She is happy.', ['She is not happy.', 'She not is happy.', 'She is happy not.'], 'She is not happy.'), q('Transforme: They are here.', ['They are not here.', 'They not are here.', 'They is not here.'], 'They are not here.'), q('Corrija: It are not new.', ['It is not new.', 'It am not new.', 'It not is new.'], 'It is not new.')],
  },
  {
    ...
    guided: [q('Qual opção é pergunta?', ['You are ready.', 'Are you ready?', 'You are not ready.'], 'Are you ready?'), q('Complete: ___ she your sister?', ['Are', 'Am', 'Is'], 'Is'), q('Complete: ___ they ready?', ['Are', 'Is', 'Am'], 'Are'), q('Corrija: Do you are a student?', ['Are you a student?', 'Do you student?', 'You are a student?'], 'Are you a student?'), q('Qual pergunta está correta?', ['Is it correct?', 'It is correct?', 'Do it is correct?'], 'Is it correct?'), q('Complete: ___ I late?', ['Am', 'Are', 'Is'], 'Am'), q('Qual pergunta combina com “we”?', ['Is we okay?', 'Are we okay?', 'Am we okay?'], 'Are we okay?'), q('Escolha a pergunta A1 correta.', ['Are you from Brazil?', 'Do you are from Brazil?', 'You from Brazil are?'], 'Are you from Brazil?')],
    transforms: [q('Transforme em pergunta: You are ready.', ['Are you ready?', 'You are ready?', 'Is you ready?'], 'Are you ready?'), q('Transforme: She is here.', ['Is she here?', 'She is here?', 'Are she here?'], 'Is she here?'), q('Transforme: They are students.', ['Are they students?', 'Is they students?', 'They are students?'], 'Are they students?'), q('Corrija: Are it blue?', ['Is it blue?', 'It is blue?', 'Am it blue?'], 'Is it blue?')],
  },
  {
    ...
    guided: [q('Resposta correta para “Are you ready?”', ['Yes, I do.', 'Yes, I am.', 'Yes, I is.'], 'Yes, I am.'), q('Resposta correta para “Is she here?”', ['Yes, she is.', 'Yes, she are.', 'Yes, she am.'], 'Yes, she is.'), q('Resposta correta para “Are they students?”', ['Yes, they is.', 'Yes, they are.', 'Yes, they am.'], 'Yes, they are.'), q('Resposta negativa para “Is it blue?”', ['No, it is not.', 'No, it are not.', 'No, it do not.'], 'No, it is not.'), q('Qual resposta combina com to be?', ['No, I am not.', 'No, I do not.', 'No, I have not.'], 'No, I am not.'), q('Complete: Are we okay? Yes, we ___.', ['is', 'are', 'am'], 'are'), q('Complete: Am I late? No, you ___ not.', ['am', 'is', 'are'], 'are'), q('Qual par está correto?', ['Is he here? Yes, he is.', 'Is he here? Yes, he are.', 'Is he here? Yes, he do.'], 'Is he here? Yes, he is.')],
    transforms: [q('Complete a resposta: Are you Brazilian? Yes, I ___.', ['am', 'is', 'are'], 'am'), q('Complete: Is Ana a student? Yes, she ___.', ['are', 'is', 'am'], 'is'), q('Complete: Are Luis and Ana ready? Yes, they ___.', ['are', 'is', 'am'], 'are'), q('Corrija: Yes, she are.', ['Yes, she is.', 'Yes, she am.', 'Yes, she do.'], 'Yes, she is.')],
  },
  {
    ...
    guided: [q('Complete: ___ name is Ana.', ['She', 'Her', 'He'], 'Her'), q('Complete: ___ phone is black.', ['I', 'Me', 'My'], 'My'), q('Complete: ___ name is Pedro.', ['His', 'He', 'Him'], 'His'), q('Qual frase está correta?', ['I name is Luis.', 'My name is Luis.', 'Me name is Luis.'], 'My name is Luis.'), q('Complete: ___ book is new.', ['Her', 'She', 'He'], 'Her'), q('Qual palavra indica posse?', ['my', 'I', 'am'], 'my'), q('Complete: ___ family is small.', ['My', 'I', 'Me'], 'My'), q('Corrija: You phone is blue.', ['Your phone is blue.', 'You are phone blue.', 'You phone blue is.'], 'Your phone is blue.')],
    transforms: [q('Corrija: I name is Luis.', ['My name is Luis.', 'Me name is Luis.', 'I am name Luis.'], 'My name is Luis.'), q('Corrija: She book is here.', ['Her book is here.', 'His book is here.', 'She is book here.'], 'Her book is here.'), q('Corrija: He phone is new.', ['His phone is new.', 'Her phone is new.', 'He is phone new.'], 'His phone is new.'), q('Escolha o modelo correto.', ['Your name is Ana.', 'You name is Ana.', 'You are name Ana.'], 'Your name is Ana.')],
  },
];
