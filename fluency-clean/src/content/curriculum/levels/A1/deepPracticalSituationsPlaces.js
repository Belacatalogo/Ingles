...
Local: You’re welcome.`,
    ...
    listeningComprehension: [q('What place does the visitor need?', 'the pharmacy', 'Where is the pharmacy?', '', ['the pharmacy','the school','the bank']), q('Where is the pharmacy?', 'on Main Street', 'The pharmacy is on Main Street.', '', ['on Main Street','near the school','at the park']), q('What is the pharmacy next to?', 'the supermarket', 'It is next to the supermarket.', '', ['the supermarket','the café','the hotel'])],
