...
Ana: Bruno is from Brazil too. He lives in Curitiba.`,
    ...
    listeningComprehension: [q('Áudio da aula — where is Ana from?', 'Brazil', 'Ela diz I am from Brazil.', ['Brazil','Curitiba','Recife']), q('Is Ana Brazilian?', 'Yes', 'Ela diz Yes, I am Brazilian.', ['Yes','No','Not mentioned']), q('What is Ana’s city?', 'Recife', 'Ela diz My city is Recife.', ['Recife','Curitiba','Brazil']), q('Where does Ana live?', 'Recife', 'Ela diz I live in Recife.', ['Recife','Brazil','Canada']), q('Where does Bruno live?', 'Curitiba', 'He lives in Curitiba.', ['Curitiba','Recife','Brazilian']), q('Is Bruno from Brazil too?', 'Yes', 'Bruno is from Brazil too.', ['Yes','No','Only Ana']), q('Áudio da aula — what word signals origin?', 'from', 'I am from Brazil.', ['from','city','teacher']), q('Áudio da aula — what phrase means morar em?', 'live in', 'I live in Recife.', ['live in','from','years old'])],
