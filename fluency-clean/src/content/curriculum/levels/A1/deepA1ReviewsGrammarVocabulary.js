...
export const A1_DEEP_REVIEWS_GRAMMAR_VOCABULARY = Object.freeze([
  createGrammarLesson({
    ...
    commonBrazilianMistakes: [mistake('She are my sister.', 'She is my sister.', 'She usa is.'), mistake('He name is Pedro.', 'His name is Pedro.', 'His é possessivo.'), mistake('A apple.', 'An apple.', 'Apple começa com som de vogal.'), mistake('This books are good.', 'These books are good.', 'Plural usa these.'), mistake('There is two chairs.', 'There are two chairs.', 'Plural usa there are.')],
  ...
  createVocabularyLesson({
    ...
    recognitionPractice: [task('Classifique: coffee', 'food/drinks'), task('Classifique: pharmacy', 'places'), task('Classifique: jacket', 'clothes'), task('Classifique: tired', 'feelings'), task('Classifique: wake up', 'routine')],
