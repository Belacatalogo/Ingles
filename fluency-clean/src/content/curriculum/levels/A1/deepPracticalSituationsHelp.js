...
Student: Okay. Thank you.`,
    ...
    listeningComprehension: [q('Who needs help?', 'the student', 'Student: Can you help me, please?', '', ['the student','the teacher','the clerk']), q('What word does the teacher repeat?', 'pharmacy', 'Repeat: pharmacy.', '', ['pharmacy','coffee','jacket']), q('Áudio da aula — Asking for help — where should the student write it?', 'in the notebook', 'Write it in your notebook.', '', ['in the notebook','on the door','in the kitchen'])],
