...
export const A1_DEEP_PRACTICAL_SITUATIONS = Object.freeze([
  ...
  createVocabularyLesson({
    ...
    recognitionPractice: [task('Escolha a bebida: water / sandwich / egg', 'water'), task('Escolha a comida: coffee / tea / sandwich', 'sandwich'), task('Qual é mais educado para pedir?', 'Can I have a coffee, please?'), task('Breakfast significa...', 'café da manhã'), task('Dinner significa...', 'jantar/refeição da noite')],
...
Customer: Thank you.`,
    ...
    listeningComprehension: [q('What drink does the customer order?', 'coffee', 'Can I have a coffee, please?', '', ['coffee','tea','water']), q('What food does the customer order?', 'an egg sandwich', 'An egg sandwich, please.', '', ['an egg sandwich','bread and butter','salad']), q('Is the order for here or to go?', 'for here', 'For here, please.', '', ['for here','to go','online'])],
