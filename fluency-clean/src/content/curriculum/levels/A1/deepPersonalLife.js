...
export const A1_DEEP_PERSONAL_LIFE = Object.freeze([
  ...
  createReadingLesson({
    ...
    evidenceQuestions: [q('How old is Luis?', '20 years old', 'I am 20 years old.', 'A idade aparece no início.', ['20','19','21']), q('Where does Luis live?', 'Santa Maria', 'I live in Santa Maria.', 'live in indica cidade.', ['Santa Maria','Recife','Brazil']), q('Is his English class online?', 'Yes, it does', 'My English class is online.', 'A frase diz diretamente.', ['Yes, it does','No, it does not','Not mentioned']), q('What is his phone number?', '550329', 'My phone number is 550329.', 'phone number indica telefone.', ['550329','luis@example.com','twenty']), q('What is his favorite hobby?', 'photo editing', 'My favorite hobby is photo editing.', 'favorite hobby indica preferência.', ['photo editing','English class','phone number'])],
...
Luis: Photo editing.`,
    ...
    listeningComprehension: [q('Áudio da aula — what is Luis’s city?', 'Santa Maria', 'My city is Santa Maria.', '', ['Santa Maria','Recife','Curitiba']), q('What is his favorite hobby?', 'photo editing', 'My favorite hobby is photo editing.', '', ['photo editing','music','reading']), q('Does the teacher ask for his email address?', 'Yes, it does', 'What is your email address?', '', ['Yes, it does','No, it does not','Not mentioned'])],
