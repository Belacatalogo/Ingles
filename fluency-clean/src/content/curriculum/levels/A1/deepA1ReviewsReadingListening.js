...
export const A1_DEEP_REVIEWS_READING_LISTENING = Object.freeze([
  createReadingLesson({
    ...
    secondReadTasks: [task('Quando Ana trabalha?', 'in the morning', 'She works in the morning'), task('Quando Ana estuda inglês?', 'at night: ela estuda à noite.', 'studies English at night'), task('Onde ela compra comida?', 'at the market', 'buys food at the market'), task('Por que ela usa jacket?', 'because the classroom is cold', 'wears a jacket because the classroom is cold')],
    evidenceQuestions: [
