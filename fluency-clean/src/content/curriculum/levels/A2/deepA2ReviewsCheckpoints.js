...
export const A2_DEEP_REVIEWS_CHECKPOINTS = Object.freeze([
  createGrammarLesson({
    ...
    guidedPractice: [q('Qual frase combina Past Simple com but corretamente?', 'Last weekend, I went to a restaurant, but I didn’t like the food.', '', 'Went (afirmativa) + didn’t like (negativa) conectados por but.', ['Last weekend, I went to a restaurant, but I didn’t like the food.', 'Last weekend, I go to a restaurant, but I didn’t liked the food.', 'Last weekend, I went to a restaurant, but I don’t like the food.']), q('Escolha a pergunta no Past Simple formada corretamente.', 'Did you see the message I sent yesterday?', '', 'Did + sujeito + verbo base; sent fica dentro da cláusula relativa.', ['Did you see the message I sent yesterday?', 'Did you saw the message I sent yesterday?', 'Do you see the message I sent yesterday here?'])],
  ...
  createGrammarLesson({
    ...
    guidedPractice: [q('Qual frase integra Present Simple e Present Continuous?', 'I usually work in the morning, but I’m studying English now.', '', 'Usually = hábito (Simple); now = ação atual (Continuous).', ['I usually work in the morning, but I’m studying English now.', 'I usually am working in the morning, but I study English now.', 'I usually works in the morning, but I’m study English now.']), q('Qual alternativa usa going to com comparação?', 'We’re going to buy the cheaper option because it is better.', '', 'Going to para plano + comparativo cheaper + because para razão.', ['We’re going to buy the cheaper option because it is better.', 'We’re going to buy the more cheap option because it is better.', 'We’re go to buy the cheaper option because it is more better.'])],
  ...
  createGrammarLesson({
    ...
    guidedPractice: [q('Qual frase usa didn’t com comparação corretamente?', 'I didn’t buy the expensive one because this one was cheaper.', '', 'Didn’t + buy (base) e cheaper (comparativo) na mesma frase.', ['I didn’t buy the expensive one because this one was cheaper.', 'I didn’t bought the expensive one because this one was cheaper.', 'I don’t buy the expensive one because this one was more cheap.']), q('Qual alternativa combina going to com need?', 'I’m going to call her, but I need your help first.', '', 'Going to para plano + but para contraste + need para necessidade.', ['I’m going to call her, but I need your help first.', 'I’m going to call her, but I needing your help first.', 'I’m go to call her, but I need your help first here.'])],
  ...
  createVocabularyLesson({
    ...
    recognitionPractice: [{ question: 'Vocabulary Review A2 — qual vocabulário desta aula significa "reserva"?', options: ['reservation', 'receipt', 'size'], answer: 'reservation', explanation: 'reservation = reserva; vocabulário trabalhado nesta aula de Vocabulary Review A2.' }, task('Qual palavra combina com hotel?', 'reservation'), task('Qual palavra combina com compra?', 'receipt/size/price'), task('Qual chunk pede ajuda?', 'Could you help me?'), task('Qual palavra significa preocupado?', 'worried')],
