...
Customer: Okay. Thank you.`,
    ...
    listeningComprehension: [q('What is the problem?', 'the app is freezing', 'the app is freezing', '', ['the app is freezing','the phone is broken','the charger is missing']), q('Where does it stop?', 'password screen', 'It stops on the password screen.', '', ['password screen','camera','home page']), q('Did the customer restart the phone?', 'yes', 'Yes, I restarted it this morning.', '', ['yes','no','not mentioned']), q('What should the customer do?', 'update the app and try again', 'Please update the app and try again.', '', ['update app','buy new phone','change charger'])],
