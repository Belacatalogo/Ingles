...
Advice: Drink water and rest today. You can take this medicine after lunch. Do not take more than two pills in one day. If you have a fever or feel worse tomorrow, see a doctor.`,
    ...
    evidenceQuestions: [q('What symptoms does the person have?', 'headache and cough', 'You have a headache and a cough.', '', ['headache and cough','fever and back pain','stomachache']), q('What should the person drink?', 'water', 'Drink water and rest today.', '', ['water','exercise','rest']), q('When can the person take the medicine?', 'after lunch', 'take this medicine after lunch', '', ['after lunch','before breakfast','at night']), q('What should the person not do?', 'take more than two pills in one day', 'Do not take more than two pills in one day.', '', ['take more than two pills','drink lots of water','rest and sleep more']), q('When should the person see a doctor?', 'if they have a fever or feel worse tomorrow', 'If you have a fever or feel worse tomorrow, see a doctor.', '', ['if fever or worse','if hungry','if better'])],
...
Pharmacist: If you feel worse tomorrow, see a doctor.`,
    ...
    listeningComprehension: [q('Áudio da aula — At the pharmacy — what symptoms does the customer have?', 'headache and cough', 'I have a headache and a cough.', '', ['headache and cough','fever and pain','stomachache']), q('Áudio da aula — At the pharmacy — does the customer have a fever?', 'no, it did not', 'No, I don’t.', '', ['no, it did not','yes, it did','not mentioned']), q('When should the customer take the medicine?', 'after lunch', 'take this medicine after lunch', '', ['after lunch','before bed','in the morning']), q('How much is the medicine?', 'twelve dollars', 'It is twelve dollars.', '', ['twelve dollars','ten dollars','twenty dollars'])],
