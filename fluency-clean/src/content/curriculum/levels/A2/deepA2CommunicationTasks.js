...
export const A2_DEEP_COMMUNICATION_TASKS = Object.freeze([
  ...
  createVocabularyLesson({
    ...
    recognitionPractice: [task('Qual expressão aceita convite?', 'Sure, I’d love to.'), task('Qual expressão recusa educadamente?', 'Sorry, I can’t.'), task('Qual expressão sugere outro momento?', 'Maybe another time.')],
...
A: Great. Let’s meet at four.`,
    ...
    listeningComprehension: [q('What is the invitation?', 'have dinner', 'Would you like to have dinner with us?', '', ['have dinner','study English','buy clothes']), q('Why can’t B go on Saturday?', 'needs to work', 'I need to work on Saturday.', '', ['needs to work','is sick','has no money']), q('What alternative does A suggest?', 'Sunday afternoon', 'How about Sunday afternoon?', '', ['Sunday afternoon','Friday night','Monday morning']), q('What time will they meet?', 'at four', 'Let’s meet at four.', '', ['at four','at five','at three'])],
