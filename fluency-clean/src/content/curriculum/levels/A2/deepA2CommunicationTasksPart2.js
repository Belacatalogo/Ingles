...
export const A2_DEEP_COMMUNICATION_TASKS_PART2 = Object.freeze([
  ...
  createVocabularyLesson({
    ...
    recognitionPractice: [task('Qual palavra significa entediado?', 'bored'), task('Qual expressão significa preocupado com?', 'worried about'), task('Qual frase dá opinião?', 'In my opinion / I think')],
