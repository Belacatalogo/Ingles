...
export const A2_DEEP_PLANS_AND_NOW_PART2 = Object.freeze([
  ...
  createVocabularyLesson({
    ...
    recognitionPractice: [task('Qual palavra significa meta?', 'goal'), task('Qual palavra significa revisão?', 'review'), task('Qual palavra significa progresso?', 'progress')],
  ...
  createReadingLesson({
    ...
    evidenceQuestions: [q('What is the student’s goal?', 'to improve listening and speaking', 'My goal is to improve my listening and speaking.', '', ['improve listening and speaking','buy a phone','travel']), q('When is the student studying this month?', 'every night after work', 'I am studying English every night after work.', '', ['every night after work','only on Sundays','in the morning']), q('What does the student usually review on Saturdays?', 'vocabulary', 'I usually review vocabulary on Saturdays.', '', ['vocabulary','grammar tests','emails']), q('What is the student’s problem?', 'forgetting new words quickly', 'I forget new words quickly.', '', ['forgetting new words','no schedule','phone problem']), q('What is the student doing to improve?', 'taking notes and reviewing mistakes', 'I am taking notes and reviewing my mistakes.', '', ['taking notes and reviewing mistakes','buying books','traveling'])],
...
Student: I am taking notes and reviewing my mistakes.`,
    ...
    listeningComprehension: [q('What does the student want to improve?', 'listening', 'I want to improve my listening.', '', ['listening','writing','shopping']), q('When does the student usually study?', 'on weekends', 'I usually study on weekends.', '', ['on weekends','every morning','after lunch']), q('What is the student doing this month?', 'studying every night', 'this month I am studying every night', '', ['studying every night','not studying','traveling']), q('What is difficult?', 'remembering new words / forgetting new words', 'I forget new words quickly.', '', ['forgetting new words','grammar rules','phone problem'])],
