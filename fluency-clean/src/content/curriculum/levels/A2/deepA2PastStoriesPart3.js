...
export const A2_DEEP_PAST_STORIES_PART3 = Object.freeze([
  ...
  createVocabularyLesson({
    ...
    recognitionPractice: [task('Qual palavra é pessoa?', 'waiter'), task('Qual palavra é preço?', 'expensive/cheap/bill'), task('Qual palavra é sobremesa?', 'dessert'), task('Qual phrase pede a conta?', 'The bill, please.')],
...
Message: Hi, I bought this blue jacket yesterday, but it is too small. I didn’t try it on in the store because I was in a hurry. Can I exchange it for size L? I have the receipt.`,
    ...
    evidenceQuestions: [q('What did the person buy?', 'a blue jacket', 'Item: Blue jacket', '', ['a blue jacket','black shoes','a white shirt']), q('What size is the jacket?', 'M', 'Size: M', '', ['M','L','S']), q('What was the discount?', '$10', 'Discount: $10', '', ['$10','$50','$60']), q('Why does the person want to exchange it?', 'because it is too small', 'it is too small', '', ['too small','too expensive','wrong color']), q('What size does the person want?', 'L', 'exchange it for size L', '', ['L','M','S'])],
