...
export const A2_DEEP_PAST_STORIES_PART3 = Object.freeze([
  createGrammarLesson({
    ...
    guidedPractice: [q('Qual frase usa Past Simple negative corretamente?', 'I didn’t like the salad because it was too small.', '', 'Didn’t + verbo base (like) é a forma correta do passado negativo.', ['I didn’t like the salad because it was too small.', 'I didn’t liked the salad because it was small.', 'I don’t like the salad because it was too small.']), q('Qual alternativa corrige o erro didn’t went?', 'I didn’t go to the restaurant last night.', '', 'Depois de didn’t o verbo volta para a forma base: go, não went.', ['I didn’t go to the restaurant last night.', 'I didn’t went to the restaurant last night.', 'I don’t went to the restaurant last night.'])],
