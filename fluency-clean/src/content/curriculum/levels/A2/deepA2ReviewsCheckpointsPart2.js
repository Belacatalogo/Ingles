...
A: Sure. You should arrive before seven because it gets busy after that.`,
    ...
    listeningComprehension: [q('What does B have to finish?', 'a report', 'I have to finish a report', '', ['a report','a reservation','a message']), q('Where is the café?', 'near the station', 'near the station', '', ['near the station','near the office','inside the hotel']), q('How does A compare the café?', 'cheaper and quieter', 'cheaper than the restaurant... and quieter', '', ['cheaper and quieter','more expensive','busier']), q('What does B ask A to send?', 'the address', 'Could you send me the address?', '', ['the address','the receipt','the schedule']), q('When should B arrive?', 'before seven', 'You should arrive before seven', '', ['before seven','after seven','before six'])],
...
A: Yes, please call us if you are more than ten minutes late.`,
    ...
    listeningComprehension: [q('What time is the appointment?', 'at two', 'appointment at two', '', ['at two','at ten','after work']), q('Why is B going to be late?', 'took the wrong bus', 'I took the wrong bus', '', ['took the wrong bus','lost ID card','forgot the address']), q('Where is B now?', 'near the station', 'now I’m near the station', '', ['near the station','next to the pharmacy','at the clinic']), q('Where is the clinic?', 'next to the pharmacy', 'The clinic is next to the pharmacy', '', ['next to the pharmacy','inside the station','near work']), q('What does B have to bring?', 'ID card', 'you have to bring your ID card', '', ['ID card','work documents','notebook']), q('When should B call again?', 'if more than ten minutes late', 'if you are more than ten minutes late', '', ['if more than ten minutes late','before taking bus','after work'])],
