...
export const A2_DEEP_COMPARISONS_NEEDS_PART4 = Object.freeze([
  ...
  createReadingLesson({
    ...
    evidenceQuestions: [q('What did the person try on first?', 'a blue jacket', 'First, I tried on a blue jacket.', '', ['blue jacket','black jacket','shoes']), q('What was the problem with the blue jacket?', 'it was too tight', 'it was too tight', '', ['too tight','too loose','too dirty']), q('Who showed the black jacket?', 'my brother', 'my brother showed me a black jacket', '', ['brother','seller','friend']), q('What did they compare after that?', 'prices and quality', 'we compared the prices and the quality', '', ['prices and quality','colors only','stores']), q('Why did the person buy the black jacket?', 'best choice for work', 'because it was the best choice for work', '', ['best choice for work','cheapest','brother wanted it'])],
