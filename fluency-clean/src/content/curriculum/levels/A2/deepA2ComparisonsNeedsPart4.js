...
export const A2_DEEP_COMPARISONS_NEEDS_PART4 = Object.freeze([
  createGrammarLesson({
    ...
    guidedPractice: [q('Qual frase usa possessive pronouns corretamente?', 'My jacket is cheaper, but yours is more comfortable.', '', 'Yours substitui your jacket, evitando repetição.', ['My jacket is cheaper, but yours is more comfortable.', 'My jacket is cheaper, but your is more comfortable.', 'My jacket is cheaper, but you is more comfortable here.']), q('Escolha o uso correto de mine e hers.', 'This phone is mine. The newer one is hers.', '', 'Mine = my phone; hers = her phone. Sem repetir o substantivo.', ['This phone is mine. The newer one is hers.', 'This phone is mine. The newer one is her.', 'This phone is my. The newer one is hers now.'])],
