...
export const A2_DEEP_PAST_STORIES = Object.freeze([
  ...
  createVocabularyLesson({
    ...
    recognitionPractice: [{ question: 'Transportation — qual vocabulário desta aula significa "ônibus"?', options: ['bus', 'train', 'subway'], answer: 'bus', explanation: 'bus = ônibus; vocabulário trabalhado nesta aula de Transportation.' }, task('Qual palavra é lugar de trem?', 'station/platform'), task('Qual palavra é problema?', 'delay/traffic'), task('Qual chunk significa descer?', 'get off')],
...
Receptionist: Yes, it is on the second floor, away from the main street. Very quiet.`,
    ...
    listeningComprehension: [q('Áudio da aula — Hotel check-in dialogue — what is the guest’s name?', 'Ana Souza', 'My name is Ana Souza.', '', ['Ana Souza','Maria Costa','Paula Lima']), q('What room type does she have?', 'single room', 'a single room for two nights', '', ['single room','double room','family room']), q('What is her room number?', '204', 'Your room is 204.', '', ['204','240','402']), q('What time is breakfast?', 'at seven', 'Breakfast is at seven.', '', ['at seven','at eight','at nine'])],
