...
export const A2_DEEP_PAST_STORIES_PART2 = Object.freeze([
  ...
  createVocabularyLesson({
    ...
    recognitionPractice: [task('Qual palavra é serviço?', 'breakfast'), task('Qual palavra é problema?', 'noisy/dirty/key card didn’t work'), task('Qual palavra é item do quarto?', 'towel/shower/key card')],
...
Customer: No, thank you. And later, can I have the bill, please?`,
    ...
    listeningComprehension: [q('What does the customer order?', 'pasta', 'I’d like the pasta, please.', '', ['pasta','pizza','soup']), q('Does the customer want salad?', 'yes, a small salad', 'Yes, a small salad, please.', '', ['yes','no','not mentioned']), q('What does the customer drink?', 'water', 'Can I have water, please?', '', ['water','coffee','juice']), q('What does the customer ask for later?', 'the bill', 'can I have the bill, please?', '', ['the bill','the menu','the key'])],
