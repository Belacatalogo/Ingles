...
Customer: No, thank you. And later, can I have the bill, please?`,
    ...
    listeningComprehension: [q('What does the customer order?', 'pasta', 'I’d like the pasta, please.', '', ['pasta','pizza','soup']), q('Áudio da aula — Ordering in a restaurant — does the customer want salad?', 'yes, a small salad', 'Yes, a small salad, please.', '', ['yes','no','not mentioned']), q('What does the customer drink?', 'water', 'Can I have water, please?', '', ['water','coffee','juice']), q('Áudio da aula — Ordering in a restaurant — what does the customer ask for later?', 'the bill', 'can I have the bill, please?', '', ['the bill','the menu','the key'])],
