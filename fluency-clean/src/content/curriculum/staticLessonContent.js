...
const B2_READY_LESSONS = Object.freeze(mergeUniqueLessons(B2_DEEP_BRIDGE_PART1, B2_DEEP_BRIDGE_PART2, B2_DEEP_NARRATIVES_PART1, B2_DEEP_ABSTRACT_DISCUSSION_PART1));

function mergePillarLessons(...parts) {
  return Object.freeze({
...
// Keep B1 alias for backward compatibility
const mergeB1PillarLessons = mergePillarLessons;
...
export const STATIC_READY_LESSONS_BY_LEVEL_AND_PILLAR = Object.freeze({
  ...
  B2: mergePillarLessons(B2_DEEP_BRIDGE_PART1_BY_PILLAR, B2_DEEP_BRIDGE_PART2_BY_PILLAR, B2_DEEP_NARRATIVES_PART1_BY_PILLAR, B2_DEEP_ABSTRACT_DISCUSSION_PART1_BY_PILLAR),
});
