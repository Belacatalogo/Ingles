...
const C1_READY_LESSONS = Object.freeze(mergeUniqueLessons(C1_DEEP_BRIDGE_PART1, C1_DEEP_BRIDGE_PART2));
...
export const STATIC_READY_LESSONS_BY_LEVEL_AND_PILLAR = Object.freeze({
  ...
  C1: mergeC1PillarLessons(C1_DEEP_BRIDGE_PART1_BY_PILLAR, C1_DEEP_BRIDGE_PART2_BY_PILLAR),
});
