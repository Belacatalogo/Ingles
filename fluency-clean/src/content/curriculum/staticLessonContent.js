...
function mergeA2PillarLessons(bridge, bridgePart2, pastStories, pastStoriesPart2, pastStoriesPart3, pastStoriesPart4, pastStoriesPart5, plansAndNow) {
  return Object.freeze({
    grammar: Object.freeze(mergeUniqueLessons(bridge.grammar || [], bridgePart2.grammar || [], pastStories.grammar || [], pastStoriesPart2.grammar || [], pastStoriesPart3.grammar || [], pastStoriesPart4.grammar || [], pastStoriesPart5.grammar || [], plansAndNow.grammar || [])),
    vocabulary: Object.freeze(mergeUniqueLessons(bridge.vocabulary || [], bridgePart2.vocabulary || [], pastStories.vocabulary || [], pastStoriesPart2.vocabulary || [], pastStoriesPart3.vocabulary || [], pastStoriesPart4.vocabulary || [], pastStoriesPart5.vocabulary || [], plansAndNow.vocabulary || [])),
    reading: Object.freeze(mergeUniqueLessons(bridge.reading || [], bridgePart2.reading || [], pastStories.reading || [], pastStoriesPart2.reading || [], pastStoriesPart3.reading || [], pastStoriesPart4.reading || [], pastStoriesPart5.reading || [], plansAndNow.reading || [])),
    listening: Object.freeze(mergeUniqueLessons(bridge.listening || [], bridgePart2.listening || [], pastStories.listening || [], pastStoriesPart2.listening || [], pastStoriesPart3.listening || [], pastStoriesPart4.listening || [], pastStoriesPart5.listening || [], plansAndNow.listening || [])),
    speaking: Object.freeze(mergeUniqueLessons(bridge.speaking || [], bridgePart2.speaking || [], pastStories.speaking || [], pastStoriesPart2.speaking || [], pastStoriesPart3.speaking || [], pastStoriesPart4.speaking || [], pastStoriesPart5.speaking || [], plansAndNow.speaking || [])),
    writing: Object.freeze(mergeUniqueLessons(bridge.writing || [], bridgePart2.writing || [], pastStories.writing || [], pastStoriesPart2.writing || [], pastStoriesPart3.writing || [], pastStoriesPart4.writing || [], pastStoriesPart5.writing || [], plansAndNow.writing || [])),
...
const A2_READY_LESSONS = Object.freeze(mergeUniqueLessons(A2_DEEP_BRIDGE, A2_DEEP_BRIDGE_PART2, A2_DEEP_PAST_STORIES, A2_DEEP_PAST_STORIES_PART2, A2_DEEP_PAST_STORIES_PART3, A2_DEEP_PAST_STORIES_PART4, A2_DEEP_PAST_STORIES_PART5, A2_DEEP_PLANS_AND_NOW));
...
export const STATIC_READY_LESSONS_BY_LEVEL_AND_PILLAR = Object.freeze({
  ...
  A2: mergeA2PillarLessons(A2_DEEP_BRIDGE_BY_PILLAR, A2_DEEP_BRIDGE_PART2_BY_PILLAR, A2_DEEP_PAST_STORIES_BY_PILLAR, A2_DEEP_PAST_STORIES_PART2_BY_PILLAR, A2_DEEP_PAST_STORIES_PART3_BY_PILLAR, A2_DEEP_PAST_STORIES_PART4_BY_PILLAR, A2_DEEP_PAST_STORIES_PART5_BY_PILLAR, A2_DEEP_PLANS_AND_NOW_BY_PILLAR),
});
