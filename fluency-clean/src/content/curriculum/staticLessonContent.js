...
function mergeA2PillarLessons(bridge, bridgePart2) {
  return Object.freeze({
    grammar: Object.freeze(mergeUniqueLessons(bridge.grammar || [], bridgePart2.grammar || [])),
    vocabulary: Object.freeze(mergeUniqueLessons(bridge.vocabulary || [], bridgePart2.vocabulary || [])),
    reading: Object.freeze(mergeUniqueLessons(bridge.reading || [], bridgePart2.reading || [])),
    listening: Object.freeze(mergeUniqueLessons(bridge.listening || [], bridgePart2.listening || [])),
    speaking: Object.freeze(mergeUniqueLessons(bridge.speaking || [], bridgePart2.speaking || [])),
    writing: Object.freeze(mergeUniqueLessons(bridge.writing || [], bridgePart2.writing || [])),
...
const A2_READY_LESSONS = Object.freeze(mergeUniqueLessons(A2_DEEP_BRIDGE, A2_DEEP_BRIDGE_PART2));
