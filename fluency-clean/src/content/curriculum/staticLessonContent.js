...
const B1_READY_LESSONS = Object.freeze(mergeUniqueLessons(B1_DEEP_BRIDGE_PART1, B1_DEEP_BRIDGE_PART2));

function mergeB1PillarLessons(bridgePart1, bridgePart2) {
  return Object.freeze({
    grammar: Object.freeze(mergeUniqueLessons(bridgePart1.grammar || [], bridgePart2.grammar || [])),
    vocabulary: Object.freeze(mergeUniqueLessons(bridgePart1.vocabulary || [], bridgePart2.vocabulary || [])),
    reading: Object.freeze(mergeUniqueLessons(bridgePart1.reading || [], bridgePart2.reading || [])),
    listening: Object.freeze(mergeUniqueLessons(bridgePart1.listening || [], bridgePart2.listening || [])),
    speaking: Object.freeze(mergeUniqueLessons(bridgePart1.speaking || [], bridgePart2.speaking || [])),
    writing: Object.freeze(mergeUniqueLessons(bridgePart1.writing || [], bridgePart2.writing || [])),
    checkpoint: Object.freeze([]),
  });
}
...
export const STATIC_READY_LESSONS_BY_LEVEL_AND_PILLAR = Object.freeze({
  ...
  B1: mergeB1PillarLessons(B1_DEEP_BRIDGE_PART1_BY_PILLAR, B1_DEEP_BRIDGE_PART2_BY_PILLAR),
});
