...
const B1_READY_LESSONS = Object.freeze(mergeUniqueLessons(B1_DEEP_BRIDGE_PART1));

function mergeB1PillarLessons(bridgePart1) {
  return Object.freeze({
    grammar: Object.freeze(mergeUniqueLessons(bridgePart1.grammar || [])),
    vocabulary: Object.freeze(mergeUniqueLessons(bridgePart1.vocabulary || [])),
    reading: Object.freeze(mergeUniqueLessons(bridgePart1.reading || [])),
    listening: Object.freeze(mergeUniqueLessons(bridgePart1.listening || [])),
    speaking: Object.freeze(mergeUniqueLessons(bridgePart1.speaking || [])),
    writing: Object.freeze(mergeUniqueLessons(bridgePart1.writing || [])),
    checkpoint: Object.freeze([]),
  });
}
...
export const STATIC_READY_LESSONS_BY_LEVEL_AND_PILLAR = Object.freeze({
  ...
  B1: mergeB1PillarLessons(B1_DEEP_BRIDGE_PART1_BY_PILLAR),
});
