...
export function createQuestion(base) {
  return {
    ...
    speakingSkillTag: base.speakingSkillTag,
    ...
    pronunciationWord: cleanPracticeText(base.pronunciationWord || ''),
    phonetic: cleanPracticeText(base.phonetic || ''),
    azureMinPassScore: typeof base.azureMinPassScore === 'number' ? base.azureMinPassScore : undefined,
    azureSkipOnFail: typeof base.azureSkipOnFail === 'boolean' ? base.azureSkipOnFail : undefined,
    scaffoldingHint: cleanPracticeText(base.scaffoldingHint || ''),
