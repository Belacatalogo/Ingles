...
window.React = module.exports.default || module.exports;
...
window.ReactDOM = module2.exports.default || module2.exports;

// ---- Lucide ----
var lucideModule={exports:{}};
(function(module,exports){
/**
...
})(lucideModule, lucideModule.exports);
window.lucide = lucideModule.exports;

// ---- Helpers ----
window.localGet=function(k){try{var v=localStorage.getItem('fluency_'+k);if(v===null)return null;try{return JSON.parse(v)}catch(e){return v}}catch(e){return null}};
window.localSet=function(k,v){try{localStorage.setItem('fluency_'+k,typeof v==='string'?v:JSON.stringify(v));return true}catch(e){return false}};
function localGet(k){return window.localGet(k);}
function localSet(k,v){return window.localSet(k,v);}

// ---- Icons ----
function makeIcon(name){return function(p){p=p||{};var s=p.size||16,cn=p.className||'',st=p.style||{},d=window.lucide[name];if(!d)return null;function ra(o){var r={};Object.keys(o).forEach(function(k){r[k.replace(/-([a-z])/g,function(_,c){return c.toUpperCase()})]=o[k]});return r}function bld(n){if(!n)return null;var t=n[0],a=ra(n[1]||{}),k=(n[2]||[]).map(bld);return window.React.createElement(t,a,k.length?k:null)}var sa=ra(d[1]||{});sa.width=s;sa.height=s;sa.className=cn;sa.style=st;var k=(d[2]||[]).map(bld);return window.React.createElement('svg',sa,k.length?k:null)}}
window.BookOpen=makeIcon("BookOpen");window.Pencil=makeIcon("Pencil");window.Headphones=makeIcon("Headphones");window.Feather=makeIcon("Feather");window.Flame=makeIcon("Flame");window.Trophy=makeIcon("Trophy");window.RotateCw=makeIcon("RotateCw");window.Check=makeIcon("Check");window.X=makeIcon("X");window.ChevronRight=makeIcon("ChevronRight");window.ChevronLeft=makeIcon("ChevronLeft");window.Volume2=makeIcon("Volume2");window.Sparkles=makeIcon("Sparkles");window.Calendar=makeIcon("Calendar");window.Home=makeIcon("Home");window.Layers=makeIcon("Layers");window.TrendingUp=makeIcon("TrendingUp");window.Loader2=makeIcon("Loader2");window.Lightbulb=makeIcon("Lightbulb");window.GraduationCap=makeIcon("GraduationCap");window.Award=makeIcon("Award");window.Cloud=makeIcon("Cloud");window.ArrowRight=makeIcon("ArrowRight");window.Pause=makeIcon("Pause");window.CheckCircle2=makeIcon("CheckCircle2");window.Star=makeIcon("Star");window.Moon=makeIcon("Moon");window.Sunrise=makeIcon("Sunrise");window.Eye=makeIcon("Eye");window.EyeOff=makeIcon("EyeOff");window.Play=makeIcon("Play");window.Shuffle=makeIcon("Shuffle");window.RefreshCw=makeIcon("RefreshCw");
